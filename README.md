...
- 🤖 Genuinely curious about how **AI is reshaping recruitment and hiring workflows**
- 📊 I enjoy turning scattered data into something that actually makes sense
- 🌱 Always upskilling — recently picked up project management and data visualization
- ⚡ Fun fact: I once beat an entire department at **Sudoku** 🧩 — yes, it's genuinely on my certificate list
...
- Handled customer engagement and product demonstrations
- Managed lead generation and customer follow-ups
- Maintained daily sales reports and data documentation

</details>

<details>
<summary><b>🧑‍💼 HR Intern — Amanah Jobs, Patna</b> <i>(Oct – Nov 2025)</i> — click to expand</summary>
<br>

- Worked on AI-assisted candidate sourcing and ATS optimization
- Supported recruitment analytics and job-posting management
- Helped build and improve resumes using AI tools
